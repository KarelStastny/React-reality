  ...
  return <section>
    <div className="container mx-auto min-h-[800px] mb-14">
      <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between'>
        ...
        <div className='nb4 lg:mb-0 flex gap-x-2 text-sm'>
      ...
      <div className='flex flex-col items-start gap-8 lg:flex-row'>
        ...
        <div className='flex-1 bg-white-100 w-full mb-8 border border-gray-300 rounded-lg px-6 py-8'>
          ...
          <form className='flex flex-col gap-y-4'>
            <input className='border border-gray-300 focus:border-violet-700 outline-none rounded px-4 h-14 w-full text-sm' placeholder='Name*' type="text" />
            <input className='border border-gray-300 focus:border-violet-700 outline-none rounded px-4 h-14 w-full text-sm' placeholder='Email*' type="text" />
            <input className='border border-gray-300 focus:border-violet-700 outline-none rounded px-4 h-14 w-full text-sm' placeholder='Phone*' type="text" />
            <textarea className='border border-gray-300 w-full focus:border-violet-700 outline-none resize-none rounded p-4 h-36 text-sm text-gray-400' placeholder='Message*' defaultValue="Hello I am interested in [Moder apartment]"></textarea>
